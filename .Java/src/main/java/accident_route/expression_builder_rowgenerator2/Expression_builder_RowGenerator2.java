...
package accident_route.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_ACCIDENT_ROUTE_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2.length) {
					if (length < 1024 && commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_ACCIDENT_ROUTE_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ACCIDENT_ROUTE_Expression_builder_RowGenerator2) {
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					public String getRandomnewColumn() {
						...
						return "" + (StringHandling.LEN(null).equals(3) && StringHandling.RIGHT(null, 1).equals("0")
								? StringHandling.LEFT(null, 2)
								: StringHandling.RIGHT(null, 2).equals("01") ? StringHandling.LEFT(null, 1) + "A"
										: StringHandling.RIGHT(null, 2).equals("02")
												? StringHandling.LEFT(null, 1) + "B"
												: null)
								+ "";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"accident_route/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 30822 characters generated by Talend Open Studio for Data Integration on the
 * 6 avril 2020 à 14:33:54 CEST
 ************************************************************************************************/